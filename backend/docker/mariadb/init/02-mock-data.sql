...
('sprof_seed_01', 'usr_seed_supplier01', '(주)한맛식품',     '김대한', '031-111-2222', 'supplier@test.com',  '경기 화성',   'snack,frozen',    '자동화 스낵라인 3개, 냉동포장 라인 2개, 품질검사실',          '월 50,000개', '1,000개', 1, 1, 1, 1, 'HACCP·ISO 22000 인증 스낵/냉동식품 전문 OEM/ODM 제조사. 30년 전통의 기술력으로 프리미엄 간식류를 생산합니다.', 'approved',  'visible', DATE_SUB(NOW(), INTERVAL 80 DAY), NOW()),
('sprof_seed_02', 'usr_seed_supplier02', '대한음료(주)',     '이음료', '043-222-3333', 'supplier2@test.com', '충북 청주',   'beverage',        'PET 충전라인 2개, 캔 충전라인 1개, 무균충전 설비',            '월 80,000병', '2,000병', 1, 0, 1, 1, '음료 전문 제조사. PET, 캔, 파우치 등 다양한 용기에 대응 가능하며 100톤/월 이상 대량 생산 체제를 갖추고 있습니다.', 'approved',  'visible', DATE_SUB(NOW(), INTERVAL 70 DAY), NOW()),
('sprof_seed_03', 'usr_seed_supplier03', '(주)서울베이커리', '박빵집', '02-333-4444',  'supplier3@test.com', '서울 강남',   'bakery,snack',    '오븐 10대, 발효실 3실, 포장라인 2개',                          '월 30,000개', '500개',   1, 1, 0, 1, '프리미엄 베이커리·스낵 전문. 소량 다품종 생산에 강하며 PB 베이커리 OEM/ODM 경험 다수 보유.', 'approved',  'visible', DATE_SUB(NOW(), INTERVAL 60 DAY), NOW()),
('sprof_seed_04', 'usr_seed_supplier04', '경남소스공업(주)', '정소스', '055-444-5555', 'supplier4@test.com', '경남 김해',   'sauce',           '소스 조합탱크 5기, 충전라인 3개, 살균설비',                    '월 20톤',     '3톤',     1, 0, 1, 0, '간장, 고추장, 드레싱 등 소스류 전문 OEM. HACCP 인증 완료.', 'approved',  'hidden', DATE_SUB(NOW(), INTERVAL 50 DAY), NOW()),
('sprof_seed_05', 'usr_seed_supplier05', '(주)제주유기농',   '오유기', '064-555-6666', 'supplier5@test.com', '제주',        'dairy,health',    '유기농 인증 가공시설, 저온살균 설비, 분말화 설비',              '월 15,000개', '200개',   0, 1, 0, 0, '제주 청정 원료 기반 유기농 건강식품·유제품 전문. 소량 프리미엄 제품에 특화.', 'submitted', 'hidden', DATE_SUB(NOW(), INTERVAL 40 DAY), NOW()),
('sprof_seed_06', 'usr_seed_supplier06', '부산수산식품(주)', '최수산', '051-666-7777', 'supplier6@test.com', '부산 사하',   'frozen,other',    '급속냉동기 3대, IQF 라인, 진공포장 설비',                      '월 40톤',     '1.5톤',   1, 0, 1, 1, '수산물 기반 냉동식품 전문. 급속냉동 기술로 신선도를 유지합니다.', 'draft',     'hidden', DATE_SUB(NOW(), INTERVAL 30 DAY), NOW()),
('sprof_seed_07', 'usr_seed_supplier07', '(주)전주명가',     '한전주', '063-777-8888', 'supplier7@test.com', '전북 전주',   'sauce,snack',     '전통 장류 숙성고 10동, 소스라인 2개',                          '월 25,000개', '800개',   0, 1, 0, 0, '전통 장류 및 간식 전문 ODM. 전주 전통 레시피를 현대화한 제품 개발.', 'rejected',  'hidden', DATE_SUB(NOW(), INTERVAL 20 DAY), NOW()),
('sprof_seed_08', 'usr_seed_supplier08', '인천냉동식품(주)', '임냉동', '032-888-9999', 'supplier8@test.com', '인천 남동',   'frozen',          '대형 냉동창고 2동, 만두라인 4개, 포장라인 3개',                '월 60톤',     '5톤',     1, 1, 1, 1, '냉동만두·냉동밥류 대량생산 전문. 월 60톤 이상 생산 가능.', 'hold',      'hidden', DATE_SUB(NOW(), INTERVAL 10 DAY), NOW())
ON DUPLICATE KEY UPDATE company_name=VALUES(company_name), monthly_capacity=VALUES(monthly_capacity), moq=VALUES(moq);
...
('req_seed_01', 'usr_seed_buyer01', 'public',   '프로틴바 OEM 제조사 찾습니다',        'snack',    '10,000개', '800원', '1,200원', 'HACCP',         'supplier_provided', 'private_label', '계약 후 30일 이내', '유기농 원료 사용 필수. 개별포장 50g 기준.', 'open', DATE_SUB(NOW(), INTERVAL 10 DAY), NOW()),
('req_seed_02', 'usr_seed_buyer01', 'public',   '과일주스 소량 생산 가능한 업체',       'beverage',  '5,000개', '1,500원', '2,500원', 'HACCP',         'requester_provided', 'bulk',         '2개월 이내',        'NFC 과일주스. 원료는 당사에서 공급.',       'open', DATE_SUB(NOW(), INTERVAL 8 DAY),  NOW()),
('req_seed_03', 'usr_seed_buyer02', 'public',   '유기농 그래놀라 ODM 의뢰',             'health',    '3,000개', '2,000원', '4,000원', 'HACCP,ORGANIC', 'supplier_provided', 'private_label', '45일 이내',         '유기농 인증 필수. 견과류 기반 그래놀라.',   'open', DATE_SUB(NOW(), INTERVAL 7 DAY),  NOW()),
('req_seed_04', 'usr_seed_buyer02', 'targeted', '냉동만두 대량생산 파트너 모집',         'frozen',   '50톤', '500원', '900원',  'HACCP',         'supplier_provided', 'bulk',         '매월 납품',         '김치만두·고기만두 2종. 월 50톤 이상.',     'open', DATE_SUB(NOW(), INTERVAL 5 DAY),  NOW()),
('req_seed_05', 'usr_seed_buyer04', 'public',   'PB 베이커리 제조 파트너',               'bakery',   '20,000개', '600원', '1,000원', 'HACCP',         'supplier_provided', 'private_label', '3개월 이내',        '편의점 PB 빵류. 다품종 소량 대응 필요.',   'open', DATE_SUB(NOW(), INTERVAL 3 DAY),  NOW()),
('req_seed_06', 'usr_seed_buyer01', 'public',   '간장소스류 OEM 제조 완료건',            'sauce',     '8,000개', '2,000원', '3,500원', 'HACCP',         'requester_provided', NULL,           '완료',              '간장·불고기소스 2종. 납품 완료.',          'closed', DATE_SUB(NOW(), INTERVAL 30 DAY), NOW()),
('req_seed_07', 'usr_seed_buyer04', 'targeted', '도시락 반찬류 냉동제품 (취소)',          'frozen',   '15,000개', '700원', '1,100원', 'HACCP',         'supplier_provided', 'bulk',         NULL,                '예산 사정으로 취소.',                       'cancelled', DATE_SUB(NOW(), INTERVAL 20 DAY), NOW()),
('req_seed_08', 'usr_seed_buyer02', 'public',   '건강음료 시제품 개발 (작성중)',          'beverage',  '1,000개', '3,000원', '5,000원', NULL,            NULL,                 NULL,           NULL,                NULL,                                        'draft', DATE_SUB(NOW(), INTERVAL 1 DAY),  NOW())
...
('quo_seed_01', 'req_seed_01', 'sprof_seed_01', '950원/개',   '2,000개', '21일', '50,000원', 'HACCP 인증 완료. 프로틴바 OEM 다수 경험.',       'submitted', 1, DATE_SUB(NOW(), INTERVAL 7 DAY), NOW()),
('quo_seed_02', 'req_seed_01', 'sprof_seed_03', '1,100원/개', '1,000개', '28일', '30,000원', '소량부터 대응 가능. 맞춤 레시피 개발 포함.',     'submitted', 1, DATE_SUB(NOW(), INTERVAL 6 DAY), NOW()),
('quo_seed_03', 'req_seed_02', 'sprof_seed_02', '1,800원/병', '3,000병', '14일', NULL,        'PET 500ml 기준. 대량 시 단가 협의 가능.',        'submitted', 1, DATE_SUB(NOW(), INTERVAL 5 DAY), NOW()),
('quo_seed_04', 'req_seed_03', 'sprof_seed_01', '2,800원/개', '1,000개', '30일', '80,000원', '유기농 원료 조달 가능. 그래놀라 ODM 경험 있음.',  'submitted', 1, DATE_SUB(NOW(), INTERVAL 4 DAY), NOW()),
('quo_seed_05', 'req_seed_06', 'sprof_seed_04', '2,500원/kg', '5톤',     '21일', NULL,        '간장·불고기소스 제조 완료. 납품 확정.',           'selected',  1, DATE_SUB(NOW(), INTERVAL 25 DAY), NOW()),
('quo_seed_06', 'req_seed_05', 'sprof_seed_03', '850원/개',   '500개',   '35일', '20,000원', '단가 재협의 희망으로 철회.',                       'withdrawn', 1, DATE_SUB(NOW(), INTERVAL 2 DAY), NOW())
ON DUPLICATE KEY UPDATE state=VALUES(state), unit_price_estimate=VALUES(unit_price_estimate), moq=VALUES(moq), lead_time=VALUES(lead_time), sample_cost=VALUES(sample_cost);
