...
('sprof_seed_01', 'usr_seed_supplier01', '(주)한맛식품',     '김대한', '031-111-2222', 'supplier@test.com',  '경기 화성',   'snack,frozen',    '자동화 스낵라인 3개, 냉동포장 라인 2개, 품질검사실',          '월 50,000개', '1,000개', 1, 1, 1, 1, 'HACCP·ISO 22000 인증 스낵/냉동식품 전문 OEM/ODM 제조사. 30년 전통의 기술력으로 프리미엄 간식류를 생산합니다.', 'approved',  'listed', DATE_SUB(NOW(), INTERVAL 80 DAY), NOW()),
('sprof_seed_02', 'usr_seed_supplier02', '대한음료(주)',     '이음료', '043-222-3333', 'supplier2@test.com', '충북 청주',   'beverage',        'PET 충전라인 2개, 캔 충전라인 1개, 무균충전 설비',            '월 80,000병', '2,000병', 1, 0, 1, 1, '음료 전문 제조사. PET, 캔, 파우치 등 다양한 용기에 대응 가능하며 100톤/월 이상 대량 생산 체제를 갖추고 있습니다.', 'approved',  'listed', DATE_SUB(NOW(), INTERVAL 70 DAY), NOW()),
('sprof_seed_03', 'usr_seed_supplier03', '(주)서울베이커리', '박빵집', '02-333-4444',  'supplier3@test.com', '서울 강남',   'bakery,snack',    '오븐 10대, 발효실 3실, 포장라인 2개',                          '월 30,000개', '500개',   1, 1, 0, 1, '프리미엄 베이커리·스낵 전문. 소량 다품종 생산에 강하며 PB 베이커리 OEM/ODM 경험 다수 보유.', 'approved',  'listed', DATE_SUB(NOW(), INTERVAL 60 DAY), NOW()),
