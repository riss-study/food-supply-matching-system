...
// ============================================================
var searchItems = [
  { _id: 'sprof_seed_01', profileId: 'sprof_seed_01', companyName: '(주)한맛식품',     region: '경기 화성', categories: ['snack','frozen'], monthlyCapacity: '월 50,000개', moq: '1,000개', oemAvailable: true,  odmAvailable: true,  verificationState: 'approved', exposureState: 'listed', logoUrl: null, updatedAt: now },
  { _id: 'sprof_seed_02', profileId: 'sprof_seed_02', companyName: '대한음료(주)',     region: '충북 청주', categories: ['beverage'],       monthlyCapacity: '월 80,000병', moq: '2,000병', oemAvailable: true,  odmAvailable: false, verificationState: 'approved', exposureState: 'listed', logoUrl: null, updatedAt: now },
  { _id: 'sprof_seed_03', profileId: 'sprof_seed_03', companyName: '(주)서울베이커리', region: '서울 강남', categories: ['bakery','snack'], monthlyCapacity: '월 30,000개', moq: '500개',  oemAvailable: true,  odmAvailable: true,  verificationState: 'approved', exposureState: 'listed', logoUrl: null, updatedAt: now }
];
...
// ============================================================
var details = [
  { _id: 'sprof_seed_01', profileId: 'sprof_seed_01', companyName: '(주)한맛식품',     representativeName: '김대한', region: '경기 화성', categories: ['snack','frozen'], equipmentSummary: '자동화 스낵라인 3개, 냉동포장 라인 2개', monthlyCapacity: '월 50,000개', moq: '1,000개', oemAvailable: true,  odmAvailable: true,  rawMaterialSupport: true,  packagingLabelingSupport: true,  introduction: 'HACCP·ISO 22000 인증 스낵/냉동식품 전문 OEM/ODM 제조사.', verificationState: 'approved',  exposureState: 'listed', logoUrl: null, certifications: [{type:'HACCP',number:'HACCP-2024-001',valid:true},{type:'ISO 22000',number:'ISO-2024-001',valid:true}], portfolioImages: [], updatedAt: now },
  { _id: 'sprof_seed_02', profileId: 'sprof_seed_02', companyName: '대한음료(주)',     representativeName: '이음료', region: '충북 청주', categories: ['beverage'],       equipmentSummary: 'PET 충전라인 2개, 캔 충전라인 1개',     monthlyCapacity: '월 80,000병', moq: '2,000병', oemAvailable: true,  odmAvailable: false, rawMaterialSupport: true,  packagingLabelingSupport: true,  introduction: '음료 전문 제조사. 대량 생산 체제.',                       verificationState: 'approved',  exposureState: 'listed', logoUrl: null, certifications: [{type:'HACCP',number:'HACCP-2024-002',valid:true},{type:'FSSC 22000',number:'FSSC-2024-001',valid:false}], portfolioImages: [], updatedAt: now },
  { _id: 'sprof_seed_03', profileId: 'sprof_seed_03', companyName: '(주)서울베이커리', representativeName: '박빵집', region: '서울 강남', categories: ['bakery','snack'], equipmentSummary: '오븐 10대, 발효실 3실',                 monthlyCapacity: '월 30,000개', moq: '500개',  oemAvailable: true,  odmAvailable: true,  rawMaterialSupport: false, packagingLabelingSupport: true,  introduction: '프리미엄 베이커리·스낵 전문.',                              verificationState: 'approved',  exposureState: 'listed', logoUrl: null, certifications: [{type:'HACCP',number:'HACCP-2024-003',valid:true}], portfolioImages: [], updatedAt: now },
  { _id: 'sprof_seed_04', profileId: 'sprof_seed_04', companyName: '경남소스공업(주)', representativeName: '정소스', region: '경남 김해', categories: ['sauce'],           equipmentSummary: '소스 조합탱크 5기, 충전라인 3개',       monthlyCapacity: '월 20톤', moq: '3톤', oemAvailable: true,  odmAvailable: false, rawMaterialSupport: true,  packagingLabelingSupport: false, introduction: '소스류 전문 OEM. HACCP 인증.',                               verificationState: 'approved',  exposureState: 'hidden', logoUrl: null, certifications: [{type:'HACCP',number:'HACCP-2024-004',valid:true}], portfolioImages: [], updatedAt: now },
  { _id: 'sprof_seed_05', profileId: 'sprof_seed_05', companyName: '(주)제주유기농',   representativeName: '오유기', region: '제주',       categories: ['dairy','health'], equipmentSummary: '유기농 인증 가공시설',                   monthlyCapacity: '월 15,000개', moq: '200개',  oemAvailable: false, odmAvailable: true,  rawMaterialSupport: false, packagingLabelingSupport: false, introduction: '제주 청정 원료 기반 유기농 건강식품 전문.',                   verificationState: 'submitted', exposureState: 'hidden', logoUrl: null, certifications: [{type:'ORGANIC',number:'ORG-2024-001',valid:false},{type:'HACCP',number:'HACCP-2024-005',valid:false}], portfolioImages: [], updatedAt: now },
  { _id: 'sprof_seed_06', profileId: 'sprof_seed_06', companyName: '부산수산식품(주)', representativeName: '최수산', region: '부산 사하', categories: ['frozen','other'], equipmentSummary: '급속냉동기 3대, IQF 라인',              monthlyCapacity: '월 40톤', moq: '1.5톤', oemAvailable: true,  odmAvailable: false, rawMaterialSupport: true,  packagingLabelingSupport: true,  introduction: '수산물 기반 냉동식품 전문.',                                 verificationState: 'draft',     exposureState: 'hidden', logoUrl: null, certifications: [], portfolioImages: [], updatedAt: now },
  { _id: 'sprof_seed_07', profileId: 'sprof_seed_07', companyName: '(주)전주명가',     representativeName: '한전주', region: '전북 전주', categories: ['sauce','snack'],   equipmentSummary: '전통 장류 숙성고 10동',                 monthlyCapacity: '월 25,000개', moq: '800개',  oemAvailable: false, odmAvailable: true,  rawMaterialSupport: false, packagingLabelingSupport: false, introduction: '전통 장류 및 간식 전문 ODM.',                                verificationState: 'rejected',  exposureState: 'hidden', logoUrl: null, certifications: [{type:'HACCP',number:'HACCP-2023-EXP',valid:false}], portfolioImages: [], updatedAt: now },
  { _id: 'sprof_seed_08', profileId: 'sprof_seed_08', companyName: '인천냉동식품(주)', representativeName: '임냉동', region: '인천 남동', categories: ['frozen'],          equipmentSummary: '대형 냉동창고 2동, 만두라인 4개',       monthlyCapacity: '월 60톤', moq: '5톤', oemAvailable: true,  odmAvailable: true,  rawMaterialSupport: true,  packagingLabelingSupport: true,  introduction: '냉동만두·냉동밥류 대량생산 전문.',                           verificationState: 'hold',      exposureState: 'hidden', logoUrl: null, certifications: [{type:'HACCP',number:'HACCP-2024-006',valid:false}], portfolioImages: [], updatedAt: now }
];
...
// ============================================================
var feed = [
  { _id: 'feed_seed_01', feedItemId: 'feed_seed_01', requestId: 'req_seed_01', requesterBusinessName: '(주)푸드마트',     title: '프로틴바 OEM 제조사 찾습니다',  category: 'snack',    desiredVolume: '10,000개', targetPriceMin: '800원', targetPriceMax: '1,200원', certificationRequirement: ['HACCP'],           mode: 'public',   isTargeted: false, hasQuoted: false, createdAt: daysAgo(10) },
  { _id: 'feed_seed_02', feedItemId: 'feed_seed_02', requestId: 'req_seed_02', requesterBusinessName: '(주)푸드마트',     title: '과일주스 소량 생산 가능한 업체', category: 'beverage', desiredVolume: '5,000개',  targetPriceMin: '1,500원', targetPriceMax: '2,500원', certificationRequirement: ['HACCP'],           mode: 'public',   isTargeted: false, hasQuoted: false, createdAt: daysAgo(8) },
  { _id: 'feed_seed_03', feedItemId: 'feed_seed_03', requestId: 'req_seed_03', requesterBusinessName: '(주)그린마켓',     title: '유기농 그래놀라 ODM 의뢰',       category: 'health',   desiredVolume: '3,000개',  targetPriceMin: '2,000원', targetPriceMax: '4,000원', certificationRequirement: ['HACCP','ORGANIC'], mode: 'public',   isTargeted: false, hasQuoted: false, createdAt: daysAgo(7) },
  { _id: 'feed_seed_04', feedItemId: 'feed_seed_04', requestId: 'req_seed_04', requesterBusinessName: '(주)그린마켓',     title: '냉동만두 대량생산 파트너 모집',   category: 'frozen',   desiredVolume: '50톤',     targetPriceMin: '500원', targetPriceMax: '900원',  certificationRequirement: ['HACCP'],           mode: 'targeted', isTargeted: true,  hasQuoted: false, createdAt: daysAgo(5) },
  { _id: 'feed_seed_05', feedItemId: 'feed_seed_05', requestId: 'req_seed_05', requesterBusinessName: '(주)편의점프레시', title: 'PB 베이커리 제조 파트너',         category: 'bakery',   desiredVolume: '20,000개', targetPriceMin: '600원', targetPriceMax: '1,000원', certificationRequirement: ['HACCP'],           mode: 'public',   isTargeted: false, hasQuoted: false, createdAt: daysAgo(3) }
];
