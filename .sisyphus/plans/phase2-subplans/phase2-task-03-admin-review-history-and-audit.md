...
| SubTask | 상태 | 메모 |
|---------|------|------|
| 3.1 | 🔴 Not Started | audit_log 현재 기록 범위 재감사 |
| 3.2 | 🔴 Not Started | 누락된 event 보강 (approve/hold/reject/suspend 등) |
| 3.3 | 🔴 Not Started | 관리자 검수 상세 API에 history timeline 추가 |
| 3.4 | 🔴 Not Started | admin-site 검수 상세 화면에 history 렌더 |
| 3.5 | 🔴 Not Started | 감사 검색/필터 API (관리자 단위) |
| 3.6 | 🔴 Not Started | 테스트/evidence |
