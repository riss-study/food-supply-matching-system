...
| 6.5 | 🔴 Not Started | 탐색/상세 응답에 ratingAvg, ratingCount 노출 |
| 6.6 | 🔴 Not Started | main-site 리뷰 작성 UI (요청자) |
| 6.7 | 🔴 Not Started | 공급자 상세 페이지에 리뷰 목록·요약 표시 |
| 6.8 | 🔴 Not Started | 모더레이션 가드 (욕설/스팸 최소 필터) |
| 6.9 | 🔴 Not Started | 테스트/evidence |
